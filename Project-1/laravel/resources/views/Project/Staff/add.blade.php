...
<html lang="">
	...
	<body>
		...
		<h3 class="text-center">เพิ่มสิทธิ์การบริหาร องค์การนักศึกษา</h3> <br>
		<form action="" method="POST" role="form">

			<div class="container">
			<div class="form-group">
				<label for="">PSU Passport</label>
				<div class="row">
				<div class="col-md-6">
				<input type="text" class="form-control" id="" placeholder=" "><br>
				<a href="{{ url('project/student/form') }}" class="btn btn-success">ค้นหา</a><br> <br>
				<label for="">วันที่เริ่มต้นดำรงตำแหน่ง</label><br>
				<input type="date" name="" id="input" class="form-control" value="" required="required" title=""><br>
				<label for="">วันที่เสิ้นสุดดำรงตำแหน่ง</label><br>
				<input type="date" name="" id="input" class="form-control" value="" required="required" title=""><br>
		...
		<a href="{{ url('project/Staff/Addorganizations') }}" class="btn btn-success">เพิ่มสิทธิ์</a>
