	...
	<body>
		...
		<div class="jumbotron">
			<div class="container">
				...
				<div class="text-center">
				<a href="" class="btn btn-success" data-toggle="modal" data-target="#edited">OK</a>
				<div class="modal fade" id="edited" role="dialog">
   								 <div class="modal-dialog modal-sm">
                             	 <div class="modal-content">
      	                      		 <div class="modal-header">
                            			 <button type="button" class="close" data-dismiss="modal">&times;</button>
                             			<h4 class="modal-title">Edit complete</h4>
                               			</div>
                                        <div class="modal-body">
                      			  <p class="text-center"><b>Compleate.</b></p>
                  				 </div>
               					 <div class="modal-footer">
               					 <a href="{{ url('project/student/index') }}" class="btn btn-default">OK</a>
